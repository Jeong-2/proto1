...
<body>
  ...
  <map name="korea2" >
  <area shape="rect" coords="333,2,463,183" alt="korea2" href="http://localhost:8081/proto1/drink/selectLocation?location=%EA%B0%95%EC%9B%90%EB%8F%84" target="_blank" /> <!-- 강원도 -->
  <area shape="rect" coords="193,1,323,182" alt="korea2" href="http://localhost:8081/proto1/drink/selectLocation?location=%EC%84%9C%EC%9A%B8%EA%B2%BD%EA%B8%B0" target="_blank" /> <!-- 서울경기 -->
  <area shape="rect" coords="184,211,376,320" alt="korea2" href="http://localhost:8081/proto1/drink/selectLocation?location=%EC%B6%A9%EC%B2%AD%EB%8F%84" target="_blank" /> <!-- 충청도 -->
  <area shape="rect" coords="186,334,341,526" alt="korea2" href="http://localhost:8081/proto1/drink/selectLocation?location=%EC%A0%84%EB%9D%BC%EB%8F%84" target="_blank" /> <!-- 전라도 -->
  <area shape="rect" coords="375,223,537,445" alt="korea2" href="http://localhost:8081/proto1/drink/selectLocation?location=%EA%B2%BD%EC%83%81%EB%8F%84" target="_blank" /> <!-- 경상도 -->
  <area shape="rect" coords="185,641,265,686" alt="korea2" href="http://localhost:8081/proto1/drink/selectLocation?location=%EC%A0%9C%EC%A3%BC%EB%8F%84" target="_blank" /> <!-- 제주도 -->
