		...
		<div class="w3-row">
			...
			<form>
				<input id="all" class="w3-check w3-quarter" type="checkbox"
					checked="checked" onClick="location.href='${pageContext.request.contextPath}/drink/drinkList'"> <label>
					&nbsp;전체보기&nbsp;</label> 
				...
				<input id="soju" class="w3-check" onClick="location.href='${pageContext.request.contextPath}/drink/drinkListsoju'"   type="checkbox"> </form>
				<label>&nbsp;소주&nbsp;</label>
			</div>
